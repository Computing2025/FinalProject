...
namespace Business.Concrete
{
    public class ProductManager : IProductService
    {
        ...
        {
          // İş kodları=> yetkisi var mı varsa getir vb. if kodları vb.
        ...
        {
            return 
                new SuccessDataResult<List<Product>>(_productDal.GetAll(
                                                        p => p.CategoryId == id)
                                                    );
        }
        ...
        {
            return 
                new SuccessDataResult<Product>(_productDal.Get(
